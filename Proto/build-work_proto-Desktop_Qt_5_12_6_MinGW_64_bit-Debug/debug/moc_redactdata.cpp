...
#include "../../../InterfacePrototype/Work/Proto/work_proto/redactdata.h"
...
void RedactData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RedactData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RedactData::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_RedactData.data,
    qt_meta_data_RedactData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
