...
#include "../../../InterfacePrototype/Work/Proto/work_proto/redacthuman.h"
...
QT_MOC_LITERAL(4, 48, 6), // "isData"
QT_MOC_LITERAL(5, 55, 4), // "data"
QT_MOC_LITERAL(6, 60, 40), // "on_building_combobox_currentI..."
QT_MOC_LITERAL(7, 101, 5) // "index"

    },
    "RedactHuman\0redacted_human\0\0"
    "on_redacted_clicked\0isData\0data\0"
    "on_building_combobox_currentIndexChanged\0"
    "index"
};
...
void RedactHuman::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RedactHuman *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->redacted_human((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->on_redacted_clicked(); break;
        case 2: { bool _r = _t->isData((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->on_building_combobox_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RedactHuman::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject RedactHuman::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_RedactHuman.data,
    qt_meta_data_RedactHuman,
    qt_static_metacall,
    nullptr,
    nullptr
} };
