...
#include "../../work_proto/managedatabase.h"
...
QT_MOC_LITERAL(5, 75, 24) // "on_redact_button_clicked"

    },
    "ManageDatabase\0update_human\0\0"
    "on_pushButton_clicked\0on_pushButton_2_clicked\0"
    "on_redact_button_clicked"
};
...
void ManageDatabase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ManageDatabase *_t = static_cast<ManageDatabase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->update_human((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->on_pushButton_2_clicked(); break;
        case 3: _t->on_redact_button_clicked(); break;
        default: ;
        }
    }
}

const QMetaObject ManageDatabase::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ManageDatabase.data,
      qt_meta_data_ManageDatabase,  qt_static_metacall, nullptr, nullptr}
};
